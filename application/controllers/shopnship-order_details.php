        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url('shopnship');?>">Shop n Ship</a>
                    </li>
                            ...
                            <table class="table newtable dataTable no-footer" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                ...
                                <?php foreach($pay_details as $pay){ ?>
                                    ...
                                    <td><?php echo $pay->type;?></td>
                                        <td>
                                            <a href="<?php echo base_url().'user/shopnship-invoice/'.$lists->shopnship_id;?>" target="_blank" class="btn btn-primary inbtn">Invoice</a>
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url().'user/shopnshippdf/'.$lists->shopnship_id;?>">
                                  ...
                                  if($message->send_by_admin == 1){
                                   ...
                                   <li class="chatli yourchat yourchat1 float-left" style="background:#edf8ff;">
                                    <div class="chatrep"><?php echo $message->message_type;?></div>
                                      ...
                                      <a href="<?php //echo base_url()?>" target="_blank" class="linkimg"><?php echo $message->msg_image?></a>
