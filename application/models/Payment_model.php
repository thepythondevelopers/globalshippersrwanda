...
public function delete_card($user_id) {
    ...
    public function update_stripecustomerid($user_id,$stripecustomerid){
       $customerid = $this->db->set('stripecustomerID',$stripecustomerid['stripecustomerID'],'is_plan_active',$stripecustomerid['is_plan_active'],'current_active_plan',$stripecustomerid['current_active_plan'])
                               ->where('id',$user_id)
