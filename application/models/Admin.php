...
class Admin extends CI_Controller {
    ...
    public function dashboard_admin(){
        if($this->session->userdata('id')){
            ...
            $order['noti_count']  = $this->Admin_model->count_notification($user_id);
            $order['address'] = $this->Admin_model->display_address();
            $order['month_order'] = $this->Admin_model->shopnship_month_count();
            $order['month_order'] = $this->Admin_model->assisted_month_count();
            $order['month_order'] = $this->Admin_model->international_month_count();
    ...
    public function shopnship_order_listing(){
        ...
        //$total['shopnship'] = $this->Admin_model->shopnship_order_receive();
    ...
    redirect(base_url().'Admin/Admin/shopnship_order_details/'.$order_id,'redresh');
    }
    ...
    redirect(base_url().'Admin/Admin/assisted_order_details/'.$order_id,'redresh');
    }
   ...
   // exit;
    redirect(base_url().'Admin/Admin/international_order_details/'.$order_id,'redresh');
    }
