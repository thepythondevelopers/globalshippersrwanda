...
class Home extends CI_Controller {
    ...
    $data['image'] = $rename.'.'.$extension;
      ...
      if($extension != "jpg" && $extension != "png" && $extension != "jpeg" && $extension != "gif" ) {
            ...
            echo "The file ". $data['image']. " has been uploaded.";
               ...
               $this->Gsr->update_photo($user_id, $data);
               echo json_encode($result);
               redirect('profile');
   }
    ...
    public function insert_address(){
        $data = [
            ...
            $result = $this->Gsr->address_insert($data);
            echo json_encode($result);
...
public function change_password(){
    ...
    if($this->form_validation->run()){
        ...
        if(strcmp($old_pass,$new_pass)==0){
            ...
            redirect('Shopnship/edit_profile_view',array('message'=>$message)) ; 
        }
    }
    else{
