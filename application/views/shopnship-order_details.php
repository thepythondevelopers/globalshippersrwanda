        ...
        <div class="container">
                ...
                <div class="table-responsive">
                    <table class="table newtable dataTable no-footer" id="table" role="grid" aria-describedby="dataTable_info">
                     ...
                     <tbody id ="listdata">
                            ...
                            <?php 
                            foreach($item_records as $lists) {
                              if($lists->order_status == 1) {
                             ...
                             ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $lists->item_price;?></td>
                                    <td><?php echo ($lists->shipment_type==1)?'Signed':'Not Signed';?></td>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 oneflex">
                            ...
                            <table class="table newtable dataTable no-footer" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                ...
                                foreach($pay_details as $pay){ ?>
                                    ...
                                    <td><?php echo $pay->type;?></td>
                                        <td>
                                            <a href="<?php echo base_url().'user/shopnship-invoice/'.$lists->shopnship_id.'/'.$pay->id;?>" target="_blank" class="btn btn-dark inbtn">Invoice</a>
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url().'user/shopnshippdf/'.$lists->shopnship_id.'/'.$pay->id;?>">
                                                <i class="fa fa-download"></i>
                                            </a>
                                        </td>
                                        <!-- <td>
                                            <a href="<?php //echo base_url().'Shopnship/shopnship_pdf';?>">
                                                <i class="fa fa-download"></i>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="<?php //echo base_url().'Shopnship/pdf/'.$lists->shopnship_id;?>">
                                                <i class="fa fa-download"></i>
                                            </a>
                                        </td> -->
                                        <!-- <td>SAS001</td>                                   
                    ...
                    <div class="srch-table shipTable mb-4">
                        <div class="itemhdr">
                            <h5 class="itemtitle mb-0">Order Remark</h5>                   
                        </div>
                        <div class="table-responsive">
                        <ul class="addcont">
                            <li>
                                <b>Remark:</b> 
                                <p><?php echo $lists->remark;?></p>
                            </li>
                        </ul>
                        </div> 
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <!-- <div class="srch-table chat-section1">
                                  ...
                                  if($message->send_by_admin == 1){
                                   ...
                                   <li class="chatli yourchat yourchat1 float-left" style="background:#edf8ff;">
                                    <div class="chatrep"><?php echo $message->message_type;?></div>
                                      ...
                                      <a href="" target="_blank" class="linkimg"><?php echo $message->msg_image?></a>
                        ...
                        <div class="chatinput-sec">
                            <select class="chatselect" name="message_type" id="message_type">
                                ...
                                <option value="<?php echo $lists->product_name ;?>">
                                    <?php echo $lists->product_name;?>
                                </option>
                                <?php }?>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="attach-file">
                                    <input type="file" name="img" id="attechinput"accept="image/png, image/jpeg" >
                                    <span class="attechicon">
                                        <i class="fas fa-paperclip"></i>
                                    </span>
                                </span>
                                <button type="button" name="submit" style="background:black;"value="<?php echo $order_id;?>"id="save">
                    ...
                    <div class="itemhdr delivery-div">
                        ...
                        <button type="button" class="btn btn-dark imgbtn" onclick="openModal()" >
                                           View Image 
                                        </button>
                                        <!-- <ul class="docs-pictures clearfix images">
                                            <li><img data-original="<?php echo base_url().$lists->image_path?>" src="<?php echo base_url().$lists->image_path?>"></li>
                                        </ul> -->
                                        <div id="myModal" class="modal">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <?php foreach($product_image as $image){?>
                                                        <div class="mySlides">
                                                             <img class="demo cursor" src="<?php echo base_url().$image->image?>" onclick="currentSlide(this)" alt="">
                                                         </div>
                                                       <?php }?>
                                              
                                            </div>
                                        </div>
                                        <!-- <a href="<?php echo base_url().$lists->image?>" rel="lightbox"><img name="<?php echo $lists->image_path;?>" src="<?php echo base_url().$lists->image_path;?>"   alt=""></a> -->
                    </div>
                </div>
            ...
            //     alert(ip);
                ...
                $.ajax({
                    ...
                    success: function(result){
                        $replay = ' <li class="chatli myChat myChat1"><div class="chatrep">' + $result.message_type + '</div><div class="chat-cont"><p>'+ $result.message +'</p><span class="reptxt">Replied By : You </span> <span class="chattime">'+ $result.created_date +'</span></div></li>';
