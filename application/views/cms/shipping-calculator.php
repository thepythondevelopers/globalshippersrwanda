<section class="shipping-cal-sec">
   ...
   <div class="text-center mx-auto mb-5" style="max-width: 800px;">
      <p class="fs-4 text-uppercase text-primary"><?php $title->title;?></p>
      <h1 class="display-4 mb-4">GSR Shipping Rates </h1>
   </div>
   <div class="row">
   <div class="col-lg-6">
            ...
            <div class="col-lg-12">
               <div class="price-row">
                  ...
                  <ul>
                     ...
                     <div class="d-flex justify-content-between"><div class="d-date">2-5 Days</div><div><?php //if(isset($sp_fedex_price)) {echo $sp_fedex_price. ' USD';} ?>
                       <p id="fedex_price"></p>  
      ...
      <div class="col-lg-6">
         <div class="shipping-cal-content p-4">
            ...
            <p>Stackry works with major international shipping carriers including DHL, Fedex, Aramex and USPS. Enter your package dimensions and weight for estimated shipping cost and carrier availability in your country or territory.</p>
            <p>Learn more about optional Stackry services that can help you SAVE BIG on international shipping:</p>
            <ul>
               <li><a href="javascript:void(0);">Pricing</a> for Stackry optional shipping services</li>
               <li><a href="javascript:void(0);">Save with Stackry;</a>  we can help significantly reduce international shipping costs</li>
            </ul>
            <p>Can’t find your country or territory? Contact the Stackry team and we will provide you with a quote.</p>
            <p>Changes in weight, dimensions, item value, and product classification can impact your final quote.</p> -->
         </div>
      </div>
   </div>
</section>
