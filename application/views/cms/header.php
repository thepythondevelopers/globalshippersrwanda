...
<html lang="en">
    <head>
        ...
        <meta content="<?php echo $meta_key;?>" name="keywords">
        ...
        <!-- <link href="<?php echo base_url()?>assets/cms/css/privacy.css" rel="stylesheet"> -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-S0N9LCCHXN"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
             gtag('config', 'G-S0N9LCCHXN');
        </script>
        <meta name="google-site-verification" content="XZ1uZSEXPwLyq6u22G4HWwtw5t52BOAsUkPUd8nTESU" />
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                               <a href="<?php echo base_url();?>" class="nav-item nav-link <?php echo ($high == '1')?'active':'';?>">Home</a>
                                ...
                                <a href="<?php echo base_url('how-it-works');?>" class="nav-item nav-link <?php echo ($high == '3')?'active':'';?>">How It Works</a>
                                <a href="<?php echo base_url('shipping-calculator');?>" class="nav-item nav-link <?php echo ($high == '4')?'active':'';?>">Shipping Calculator</a>
                                <a href="<?php echo base_url('blog');?>" class="nav-item nav-link <?php echo ($high == '10')?'active':'';?>">Blog</a>
                            </div>
