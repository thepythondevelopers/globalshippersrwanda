                       ...
                       <?php //}?>
                        ...
                        <div class="profile-items">
                            ...
                            <div class="membership-box">
                                ...
                                <span class="membership-plan" ><?php echo ($list->current_active_plan==1)?'Monthly Plan':(($list->current_active_plan==2)?'Yearly Plan ':'');
                            echo ($list->is_plan_active==1)?' Active':'No active Plan';?></span>
                                <a href="<?php echo base_url('membership');?>">Manage Membership</a>
                            </div>
                            <a title="Edit Profile" class="" href="<?php echo base_url('profile');?>">Edit Profile</a>
                            <?php //if($this->session->userdata('payment_id')){?>
                            <a href="<?php echo base_url('dashboard')?>">Dashboard</a>
                            <?php //}else{?>
                                <!-- <a href="<?php echo base_url('my-stripe')?>">Make Payment</a> -->
                                <?php// }?>
                            <a title="Change Password" class="" href="<?php echo base_url('users/change-password')?>">Change Password</a>
