...
<div class="content-wrapper">
    ...
    <!-- <section class="content">
     ...
     <form method="post" enctype = "multipart/form-data" action="<?php echo base_url('Admin/Admin/edit_howitworks')?>" > 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="exampleInputFile" name="imgpath" value="<?php echo $data->imgpath;?>">
