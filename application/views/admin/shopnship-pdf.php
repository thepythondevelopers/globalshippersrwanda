            ...
            <tbody>
                <tr>
                    <td style="border-bottom: 1px solid #000;padding: 10px;"><img
                            src="<?php echo base_url()?>assets/imgs/logo.png" style="
    height: 45px;
"></td>
                    <td style="
            ...
            <tbody style="
                ...
                <tr>
                    ...
                    <td style="
                               ...
                               "><?php echo $record->grand_total?> inr</td>
                </tr>
                ...
                <!-- <tr>
                    <td colspan="2"></td>
                    <td colspan="2"></td>
                    <td style="text-align: right;"><span style="text-transform: uppercase;"></span></td>
                </tr> -->
                ...
                <tr style="background-color: #dddddd">
                    ...
                    <td style="text-align: right; font-weight: bold;"><?php echo $record->grand_total?>
