      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="col-md-2"><a href="<?php echo base_url('cms/help-centre-listing');?>" style="color:black;">View Help Centre</a></div>
            <form method="post" enctype="multipart/form-data"
              action="<?php echo base_url('Admin/Admin/helpqna')?>">
                    ...
                    <div class="form-group">
                     ...
                     <select  class="form-control" name="category">
                      <?php foreach( $category as $categorydata){
                        ...
                        <option selected="selected" name="catdata"
                                value="<?php echo $categorydata->cat_id;?>"><?php echo $categorydata->cat_name;?></option> 
                     <?php }?>
          ...
          <div class="modal-content">
            <form action="<?php echo base_url('Admin/Admin/helpcentercatinsert')?>" method="post">
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-dark" name="submit" value="">Save</button>
              </div>
            </form>
          </div>
        </div>
