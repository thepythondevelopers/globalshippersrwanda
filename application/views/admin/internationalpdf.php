                ...
                <tr>
                    ...
                    <td style="text-align: right;padding: 10px;vertical-align: top;">
                        ...
                        <p style="
                            ...
                            <br><?php echo $address->mobile_number;?><br>
                ...
                <tr>
                    <td style="
                        ...
                        <p style="
                               ...
                               font-size: 14px;
                               line-height: 19px;
                               "><?php echo $record[0]->international_id;?>
                        </p>
                        <!-- <p style="
                               margin: 0px;
                               color: #000;
                    ...
                    <td style="text-align: right;padding: 10px;vertical-align: top;border-top: 1px solid #000;">
                        ...
                        <p style="
                               ...
                               line-height: 19px;
                               "><?php 
                                $datetime = strtotime($record[0]->date_created);
...
<tr>
                ...
                <tr>
                    ...
                    <td colspan="2"> - </td>
                    <td style=" font-weight: bold;"><?php echo $record[0]->weight_box;?>
                </tr>
                <tr>
                    <td colspan="2">No of Box</td>
                    <td colspan="2"> - </td>
                    <td style=" font-weight: bold;"><?php echo $record[0]->no_of_box;?>
                </tr>
                <tr>
