<div class="content-wrapper">
  <section class="content-header">
    <div class="card card-default">
      ...
      <div class="card-body">
        <form action="<?php echo base_url('Admin/international-update-shipment')?>" method="post">
        ...
        <input type="hidden" name="shipid" value="<?php echo $shipment->id;?>">
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="col-md-6">
            <button class="btn btn-danger" type="submit" name="submit" style="margin-top:20px;">Submit</button>
          </div>
        </form>
      </div>
    </div>
