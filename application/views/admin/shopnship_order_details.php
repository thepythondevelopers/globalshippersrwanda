...
<?php } ?>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <form action="<?php echo base_url('update-order-status');?>" method="post">
              ...
              <input type="hidden" name="adminemail" value="<?php echo $adminemail->email;?>">
                 <button type="submit" class="float-right btn btn-dark" name="submit"value="<?php print_r($item_records[0]->shopnship_id);?>">Submit</button>
                <!-- </div> -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="sorting_asc">Tracking ID</th>
                      <th class="sorting">Item Type</th>
                      <th class="sorting">Item Name</th>
                      <th class="sorting">Item Price</th>
                      <th class="sorting">Shipment Status</th>
                      <th class="sorting">Package Size</th>
                      <th class="sorting">Package Weight(Kg)</th>
                      <th class="sorting">Total Price</th> 
                      <th class="sorting">Quantity</th>
                      <!-- <th>Image</th> -->
                      <th class="sorting">Arrived Status</th>
                      <th class="sorting">Select Status</th>
                      <th class="sorting">Edit Item</th>
                      <!-- <th></th> -->
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo ($item->shipment_type==1)?'Signed':'Not Signed';?></td>
                      <td>
                        <?php echo $item->store;?>
                      </td> 
                      <td>
                      ...
                      <td><a href="<?php echo base_url('Admin/edit-consolidate-shipment/').$item->id;?>"><button type="button" class="btn btn-dark">Edit Item</button></a> </td>
                    </tr>
                    <?php }                     ?>
                  </tbody>
                </table>
                ...
                <div class="card-footer">
                  <div class="input-group" class="mb-3">
                    <select class="form-control chatselect" name="message_type" id="message_type">
                      ...
                      <?php foreach($item_records as $item){ echo $item->product_name;?>
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-append">
                      <button type="button" class="btn btn-dark" name="submit" id="send"
                        value="<?php echo $item->shopnship_id;?>">Send</button>
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div class="modal fade" id="payModal" tabindex="-1" role="dialog" aria-labelledby="payModalLabel"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <form action="<?php echo base_url('Admin/insert-payment')?>" method="post">
              <input type="hidden" name ="id" value="<?php echo $userdetails->id;?>">
              <input type="hidden" name ="fname" value="<?php echo $userdetails->fname;?>">
              <input type="hidden" name ="lname" value="<?php echo $userdetails->lname;?>">
              <input type="hidden" name ="email" value="<?php echo $userdetails->email;?>">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="payment" placeholder="Enter your payment id" require>
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Status*</label>
                    <!-- <input type="text" class="form-control" name="status" placeholder="Enter your Status" require> -->
  ...
  <div class="container">
    <div class="row">
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><button class="btn btn-dark"><a href="<?php echo base_url().'Admin/shopnship-edit-shipment/'.$shipment->order_id.'/'.$shipment->id;?>"><i class="fa fa-edit"></i></a></button></td>
                           <td><button class="btn btn-dark"><a href="<?php echo base_url().'Admin/shopnship-delete-shipment/'.$shipment->order_id.'/'.$shipment->id;?>"><i class="fa fa-trash"></i></a></button></td>
                          </tr>
                          <?php }?>
                        </tbody>
                      </table>
          ...
          <div class="col-lg-6 payment-table">
              <div class="card wrappers">
                <div class="card-header">
                  ...
                  " data-toggle="modal" data-target="#payModal" style="margin-left:10px;">
                  <i class="fa fa-plus" aria-hidden="true"></i>
                  </button>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <td><a href="<?php echo ($pay->paymentmethod==1)?"https://buy.stripe.com/".$pay->payment_id:"https://www.paypal.com/".$pay->payment_id;?>"><?php echo ($pay->paymentmethod==1)?"https://buy.stripe.com/".$pay->payment_id:"https://www.paypal.com/".$pay->payment_id;?></a></td>
                        ...
                        <td>
                          <a href="<?php echo base_url().'admin/shopnship-invoice/'.$item->shopnship_id.'/'.$pay->id;?>" target="_blank" class="btn btn-dark inbtn">Invoice</a>
                        </td>
                        <td><a href="<?php echo base_url().'admin/shopnship-pdf/'.$item->shopnship_id.'/'.$pay->id;?>" target="_blank" class="btn btn-dark inbtn">
                        <i class="fa fa-download"></i></a>
                      </td>
                        <td><button class="btn btn-dark"><a href="<?php echo base_url().'Admin/edit-payment/'.$pay->order_id.'/'.$pay->id;?>"><i class="fa fa-edit"></i></a></button></td>
                        <td><button class="btn btn-dark"><a href="<?php echo base_url().'Admin/shopnship-delete-payment/'.$pay->order_id.'/'.$pay->id;?>"><i class="fa fa-trash"></i></a></button></td>
      ...
      <div class="modal fade" id="shipmentModal" tabindex="-1" role="dialog" aria-labelledby="shipmentModalLabel"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <form action="<?php echo base_url('Admin/shopnship-shipment')?>" method="post">
            <input type="hidden" name ="id" value="<?php echo $userdetails->id;?>">
              <input type="hidden" name ="fname" value="<?php echo $userdetails->fname;?>">
              <input type="hidden" name ="lname" value="<?php echo $userdetails->lname;?>">
              <input type="hidden" name ="email" value="<?php echo $userdetails->email;?>">
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="shipping_carrier"
                      placeholder="Enter Shipping carrier" require>
                  </div>
                  <div class="form-group">
                    <label>Tracking Number*</label>
                    <input type="text" class="form-control" name="tracking_number" placeholder="Enter tracking number" require>
                  </div>
                  <div class="form-group">
                    <label>Tracking URL*</label>
                    <input type="text" class="form-control" name="tracking_url" placeholder="Enter tracking url" require>
                  </div>
                  <div class="form-group">
  ...
  <div class="content">
    <div class="container">
      <div class="row">
        <form action="<?php echo base_url('shopnship-image-insert')?>" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $("#counter").append($msg);
          ...
          $.ajax({
            url: '<?php echo base_url().'Admin/shopnship-insert-message'?>',
            type: 'POST',
