    ...
    <section class="content-header">
        <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Edit Package Item Information - Buy For Me</h3>
              <div class="card-tools">
              </div>
            </div>
            <div class="card-body">
            <form action = "<?php echo base_url('Admin/edit-buy-for-me/'.$item_id);?>" method="post">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
              <div class="form-group">
                <label>Online Store Name/URL*</label>
                <input type="text" value="<?php echo $item_details->store;?>" class="form-control" required="required" name="store" placeholder="Enter your Online Store Name/URL">
              </div>
                <div class="form-group">
                    <label>Item Size*</label>
                    <input type="text" class="form-control" required="required" value="<?php echo $item_details->size;?>"  required="required" name="size" placeholder="Enter your Item Size">
                  </div> 
                </div>
              </div>
              <div class="row">
                 <div class="col-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <div class="select2-purple">
                      <input type="text" class="form-control" required="required" value="<?php echo $item_details->quantity;?>" name="quantity" placeholder="Enter your Item quantity">
                    </div>
                  </div>
                </div>
                   <div class="col-12 col-sm-6">
                  ...
                  <div class="select2-purple">
                      <input type="text" class="form-control" required="required" value="<?php echo $item_details->color;?>" name="color" placeholder="Enter your item color">
                    </div>
                    </div>
              </div>
               <div class="col-12 col-sm-6">
                  ...
                  <div class="select2-purple">
              <input type="text" class="form-control" required="required" value="<?php echo $item_details->total_amount;?>" name="total_amount" placeholder="Enter your total price">
                    </div>
                    </div>
              </div>
            </div>
