  <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
      ...
      <div class="container-fluid footer">
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item">
                            <!-- <h2 class="mb-4 text-white display-5">Logo.</h2> -->
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <p class=""><i class="fas fa-envelope text-white"></i>globalshippersrwanda@gmail.com</p>
        ...
        <a onClick="document.getElementById('title').scrollIntoView({ behavior: 'smooth'});" class="btn btn-primary btn-primary-outline-0 btn-md-square rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a> 
