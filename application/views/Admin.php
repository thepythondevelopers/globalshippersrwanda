...
class Admin extends CI_Controller {
    ...
    public function payment_update_view(){
        ...
        $total['count']   = $this->Admin_model->count_notification();
        $data['pay_details']  = $this->Admin_model->shopnship_update_payment_display($id);
        $this->load->view('admin/heads',$total);
    ...
    public function shopnship_update_payment(){
        ...
        $payment = $this->Admin_model->shopnship_update_payment($id,$pay);
    ...
    public function shopnship_delete_payment(){
        $id = $this->uri->segment(3);
        $result = $this->Admin_model->shopnship_delete_payment($id);
    ...
    public function assisted_update_payment(){
        ...
        $payment = $this->Admin_model->assisted_update_payment($id,$pay);
        echo json_encode($payment);
        if($payment==TRUE){
    ...
    public function assisted_delete_payment(){
        $id = $this->uri->segment(3);
        $result = $this->Admin_model->assisted_delete_payment($id);
        echo json_encode($resutl);
        if($result==TRUE){
            redirect(base_url().'assisted-order-details/'.$id);
        }
    ...
    public function international_payment_update_view(){
        $id = $this->uri->segment(3);
        $total['count']   = $this->Admin_model->count_notification();
        $data['pay_details']  = $this->Admin_model->international_update_payment_display($id);
        $this->load->view('admin/heads',$total);
    ...
    public function international_update_payment(){
        ...
        $payment = $this->Admin_model->international_update_payment($id,$pay);
        echo json_encode($payment);
        if($payment==TRUE){
    ...
    public function international_delete_payment(){
        $id = $this->uri->segment(3);
        $result = $this->Admin_model->international_delete_payment($id);
        echo json_encode($resutl);
        if($result==TRUE){
            redirect(base_url().'international-order-details/'.$id);
        }
