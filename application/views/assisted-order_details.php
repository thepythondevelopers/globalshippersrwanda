                    ...
                    <table class="table newtable dataTable no-footer" id="table">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting">SIngle Item Price</th>
                                <th class="sorting">Total Item price</th>
                                <!-- <th class="sorting">Grand Total Amount</th> -->
                            ...
                            <?php foreach($item_records as $lists){
                                ...
                                ?>
                                 <tr>
                                    ...
                                    <td><a href="<?php echo $lists->store?>" target="_blank"><?php echo $lists->store;?></a></td>
                                    <td><?php echo $lists->single_item_amount;?></td>
                                    <td><?php echo $lists->total_amount;?></td>
                                    <!-- <td><?php echo $lists->grand_total;?></td> -->
                        ...
                        <div class="table-responsive">
                            <table class="table newtable dataTable no-footer" id="table" role="grid" aria-describedby="dataTable_info">
                                ...
                                <?php foreach($pay_details as $pay) { ?>
                                    ...
                                    <td>
                                            <a href="<?php echo base_url().'user/assisted-invoice/'.$lists->assisted_id.'/'.$pay->id;?>" target="_blank" class="btn btn-dark inbtn">Invoice</a>
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url().'user/assistedpdf/'.$lists->assisted_id.'/'.$pay->id;?>">
