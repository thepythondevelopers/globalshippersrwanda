<div class="shopship-div py-5">
        <div class="container">
            <h1 class="mb-3">Pickup Shipments</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>"><i class="fa fa-home"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Pickup Shipments</li>
                </ol>
            </nav>
              ...
              >
                ...
                <?php foreach($item_records as $lists){
                               ...
                               <tr>
                                   <td><?php 
                                  // echo "<pre>";
                                  // var_dump($lists->created_date);die;
                                        // $convertdate = date("d M,y",strtotime($lists->created_date));
                                        // print_r($convertdate);
                                      
                                        $date_time= strtotime($lists->created_date);
                                        // echo "<pre>";
                                        // print_r($date_time);
                                        // exit;
                                        $convertdate = date("d M,y",$date_time);
                                        //echo "<pre>";
                                        print_r($convertdate);
                                   ...
                                   <td><?php echo $lists->international_id;?></td>
                                   ...
                                   <td><a href="<?php echo base_url().'users/international-order-details/'.$lists->international_id;?>"><i class="fa fa-eye" style="color:#000;"></i></a></td>
                               </tr>
                               <?php }
                               ?>
                </tbody>
