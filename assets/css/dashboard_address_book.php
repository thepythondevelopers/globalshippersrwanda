            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 co-md-6 ">
                        <div class="book p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="javascript:void(0);" class="editbtn"  data-bs-toggle="modal" data-bs-target="#editModal">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <button class="bttn-mid btn-fill fright" id="createSubmit">Save</button>
                                        </div>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <!-- <div class="col-lg-4 co-md-6 ">
                        <div class="book p-4">
                            <div class="d-flex justify-content-between">
                                <h4>Abijuru Fabrice</h4>
                                <a href="javascript:void(0);" class="editbtn" data-bs-toggle="modal" data-bs-target="#editModal1">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </div>
                            <p>0784651740</p>
                            <p>KN 57 St,</p>
                            <p>Kigali, City of Kigali, Rwanda, 250</p>
                            <a href="" class="delbtn">
                                <i class="fa fa-trash"></i> Remove
                            </a>
                        </div>
